...
x, y, z_hang, r, theta, n_steps, dt, times = run_simulation(1.05)
...
ax2d.set_ylabel('Radial Distance r(t) (meters)')
...
frame_skip = 3  # show every 3rd frame to speed up animation
ani = FuncAnimation(fig, update, frames=range(0, n_steps, frame_skip), init_func=init,
